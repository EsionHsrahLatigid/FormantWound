...
namespace
{
class FormantWoundStandaloneApplication final : public juce::JUCEApplication
{
public:
    FormantWoundStandaloneApplication()
    {
...
START_JUCE_APPLICATION(FormantWoundStandaloneApplication)
